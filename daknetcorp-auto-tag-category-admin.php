...
function datc_list_category(){
		...
		<table class="list-category">
	        <tbody>
	            <tr>
	                ...
	                <th class="list-item">Key word filter</th> 
	            </tr>
    ...
    <?php
    	...
    	if(empty($results) || sizeof($results) == 0)
    		echo "<p class='msg-create-tc'>Oop, you don't have any tag/category yet, please create them in <a target='_blank' href='$root'>here</a></p>";
	?>
    <script type="text/javascript"> 
...
function datc_setup_category_filter(){ ?> 
            ...
            <tbody> 
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <span id="daknetcorp_num_category_errmsg"></span><i style="color: #666; font-size: 11px;">Eg. 3</i> 
                        <a class="daknetcorp-tooltip-link" href="JavaScript:void(0);">What does this mean?</a>
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <a class="daknetcorp-tooltip-link" href="JavaScript:void(0);">What does this mean?</a>
                        <p class="des-daknetcorp">The amount of posts for each filtering.</p>
                    </td>
                </tr>
            </tbody>
        </table>
	...
	<?php //$filter_type = (isset($_REQUEST['tab']) && in_array($_REQUEST['tab'], array('category', 'tag'))) ? $_REQUEST['tab'] : 'category';?>
	<script type="text/javascript">
		...
		onlyNumber('daknetcorp_post_limit');
...
function datc_cronjob_fillter_exec() {
	// _sendmailfortest('work');
	$result_category = _datc_filter_category();
	$result_tag = _datc_filter_tag();
}

// function _sendmailfortest($content){
// 	$to      = 'test@live.com';
// 	$subject = 'stefan test';
// 	$headers  = 'MIME-Version: 1.0' . "\r\n";
// 	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
// 	$headers .= 'From: daknetcorp <info@daknetcorp.com>' . "\r\n";
...
// 	$result_tag = _datc_filter_tag();
// }
// add_shortcode( 'shortcode_daknetcorp_page', 'bartag_func' );
